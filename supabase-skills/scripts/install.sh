...
# install.sh -- Install Supabase Skills by running migration.sql files in dependency order.
# Usage:
...
ALL_SKILLS=(identity crm pipeline tasks support comms content billing calendar automations analytics)
